...
namespace BaseData.Web.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var vlist = new List<UserRole_VM>();
            list.ForEach(x =>
            {
                UserRole_VM vm = new UserRole_VM();
                vm.PrjectID = x.ProjectID;
                vm.ProjectName = db.Projects.Find(x.ProjectID).ProjectName;
                vm.RoleID = x.RoleID;
                vm.RoleName = db.Roles.Find(x.RoleID).RoleName;
                vm.Enable = x.Enable ? "已启用" : "已禁用";
                vm.UserAccount = x.UserAccount;
                vm.UserID = x.UserID;
        ...
        public async Task<ActionResult> Edit(string jsonstr)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                entiy.RoleID = model.RoleID;
                entiy.Password = model.Password;
                entiy.DepartmentID = model.DepartmentID;
                entiy.ProjectID = model.ProjectID;
                try
                {
